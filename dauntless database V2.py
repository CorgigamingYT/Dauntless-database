...
def pp (text,pause):
    print(text)
    time.sleep(pause)
def info (text,pause,Dic,monster_name,pause2):
    print(text)
    time.sleep(pause)
    print(Dic.get(monster_name))
    time.sleep(pause2)
def yorn (text,pause):
    if yorn == "yes":
        main()
...
def main():
    ...
    +15	137.5       Rams (x150), Peerless Arcstone (x9)""",
        ...
        "Fiery Breastplate":"""The Fiery Breastplate is a piece of craftable armour in Dauntless.
    It is crafted from Embermane reagents, and is part of the Embermane Armour set.
    It's stats are as follows:
    Level   Resistance  Crafting Materials
    Base    25	    Rams (x40), [[|]] (x1), [[|]] (x1)
    ...
    +15	137.5       Rams (x150), Peerless Arcstone (x9)""",
        ...
        "Fiery Gauntlets":"""The Fiery Gauntlets is a piece of craftable armour in Dauntless.
    It is crafted from Embermane reagents, and is part of the Embermane Armour set.
    It's stats are as follows:
    Level   Resistance  Crafting Materials
    Base    25	    Rams (x40), [[|]] (x1), [[|]] (x1)
    ...
    +15	137.5       Rams (x150), Peerless Arcstone (x9)""",
        ...
        "Fiery Greaves":"""The Fiery Greaves is a piece of craftable armour in Dauntless.
    It is crafted from Embermane reagents, and is part of the Embermane Armour set.
    It's stats are as follows:
    Level   Resistance  Crafting Materials
    Base    25	    Rams (x40), [[|]] (x1), [[|]] (x1)
    ...
    """,3)
            ...
            if emberb == "1":
                info("The Lesser Embermane...",3,Embermane,"Lesser Embermane",7)
                yorn2 = input("Do you want to learn about something else? ").lower()
                yorn("Okay thanks",3)
                exit()
            if emberb == "2":
                info("The Normal Embermane...",3,Embermane,"Embermane",7)
                yorn2 = input("Do you want to learn about something else? ")
                yorn("Okay thanks",3)
                exit()
            if emberb == "3":
    ...
    """,7)
            ...
            if embera == "1":
                ...
                if yorn2 == "no" or "No":
                    ...
                    exit()
            if embera == "2":
                pp("The Fiery Breastplate...",3)
                print(Embermane.get("Fiery Breastplate"))
                time.sleep(10)
                yorn2 = input("Do you want to learn about something else? ")
                if yorn2 == "yes" or "Yes":
                    os.startfile("dauntless database V2.py")
                ...
                if yorn2 == "no" or "No":
                    ...
                    exit()
            if embera == "3":
                pp("The Fiery Gauntlets...",3)
                print(Embermane.get("Fiery Gauntlets"))
                time.sleep(10)
                yorn2 = input("Do you want to learn about something else? ")
                if yorn2 == "yes" or "Yes":
                    os.startfile("dauntless database V2.py")
                ...
                if yorn2 == "no" or "No":
                    ...
                    exit()
            if embera == "4":
                pp("The Fiery Greaves...",3)
                print(Embermane.get("Fiery Greaves"))
                time.sleep(10)
                yorn2 = input("Do you want to learn about something else? ")
                if yorn2 == "yes" or "Yes":
                    os.startfile("dauntless database V2.py")
